...
function processResult(finalSymbols, wager) {
  ...
  if (
    ...
    winAmount = wager * 10;
    resultMessage.textContent = "Jackpot! You win $" + winAmount + "!";
  } else if (
    finalSymbols[0] === finalSymbols[1] ||
    finalSymbols[1] === finalSymbols[2] ||
    ...
    winAmount = wager;
    resultMessage.textContent = "You get your wager back: $" + winAmount;
  } else {
    winAmount = -wager;
...
document.getElementById("spin-button").addEventListener("click", () => {
  ...
  const finalSymbols = spinSlots();

  const winAmount = processResult(finalSymbols, wager);
